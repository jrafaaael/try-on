...
export type ValidateModel = z.infer<typeof validateModelSchema>;

export const validateGarmentSchema = z.object({
	isGarment: z.boolean().describe('boolean that indicates if the image has a valid garment'),
...
export type ValidateGarment = z.infer<typeof validateGarmentSchema>;
